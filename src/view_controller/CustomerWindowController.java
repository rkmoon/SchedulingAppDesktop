...
public class CustomerWindowController {
    ...
    private void populateCustomers() throws SQLException {
        String getAllCustString = "SELECT * FROM customers";
        DBQuery.setPrepareStatement(DBConnection.getConnection(), getAllCustString);
    ...
    private void populateCustTable(){
        FilteredList<Customer> customers = new FilteredList<>((ObjectArrays.getAllCustomers()));
